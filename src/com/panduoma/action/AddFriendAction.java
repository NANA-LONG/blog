...
public class AddFriendAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Object user = request.getSession().getAttribute("tel");
		...
		DBManager dbm = new DBManager();
		 String sql =
		 "insert into friend(tel,totel)  values('"+appuser+"','"+tel+"')";
		...
		out
				.println("<script>alert('添加好友成功！');window.location.href='friend.jsp'</script>");
		out.flush();
		out.close();
	}
