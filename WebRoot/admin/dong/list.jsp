...
<html>
	...
	<body leftmargin="8" topmargin="8"'>
			...
			<div id="printTable">
				<table width="98%" border="0" cellpadding="2" cellspacing="1"
					...
					<%
						...
						String sql = "select *  from dong d,users u where d.tel=u.tel order by d.date desc";
						if (queryName != null && queryName.trim().length() > 0) {
							sql = "select *  from dong d,users u where d.tel=u.tel   and d.tel='"
					...
					<tr align='center' bgcolor="#FFFFFF"
						...
						<td align="left">
							<div align="center">
								<a href="admin/dong/listtu.jsp?id=<%=id%>">查看</a>
						...
						<td>
							...
							<a href="DelDongAction?id=<%=id%>&type=back">删除</a>
						</td>
					</tr>
		...
		<!--  搜索表单  -->
		<form action="admin/dong/list.jsp" method="post">
