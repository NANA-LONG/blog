				...
				<td width="182" valign="top">
					<div id="container">
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/admin/admin/list.jsp" target="main">管理员维护</a>
								</li>
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/admin/users/list.jsp" target="main">会员信息维护</a>
								</li>
					...
					<h1 class="type">
						<a href="javascript:void(0)">博文管理</a>
					</h1>
					<div class="content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/admin/dong/list.jsp" target="main">博文管理</a>
							</li>
