							...
							<div class="article_listbox">
								<ul>
									<%
										...
										String sql = "select * from dong where tel ='"+session.getAttribute("tel")+"'  order by date desc";
									...
									%>
									<li>
										<span class="time"><%=rs.getString("name") %> &nbsp;&nbsp;&nbsp;&nbsp;<%=rs.getString("date") %>&nbsp;<a href="DelDongAction?id=<%=id %>"><font color="red">删除博文</font></a></span><a
